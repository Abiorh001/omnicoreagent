...
class LLMConnection:
    ...
    def llm_configuration(self):
        ...
        try:
            ...
            # Add LMStudio specific configuration if provider is lmstudio
            if provider.lower() == "lmstudio":
                os.environ["LM_STUDIO_API_BASE"] = llm_config.get("lmstudio_host", "http://localhost:1234/v1")
                os.environ["LM_STUDIO_API_KEY"] = llm_config.get("lmstudio_api_key", "")
