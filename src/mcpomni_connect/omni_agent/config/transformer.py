...
class ConfigTransformer:
    ...
    def transform_config(
        ...
        try:
            ...
            agent = self._ensure_agent_config(agent_config) if agent_config else AgentConfig()
            ...
            logger.info(f"Successfully transformed configuration for {len(tools)} MCP tools")
    ...
    def _ensure_model_config(self, config: Union[Dict[str, Any], ModelConfig]) -> ModelConfig:
    ...
    def _ensure_tool_config(self, config: Union[Dict[str, Any], MCPToolConfig]) -> MCPToolConfig:
    ...
    def _ensure_agent_config(self, config: Union[Dict[str, Any], AgentConfig]) -> AgentConfig:
    ...
    def _validate_tools_config(self, tools: List[MCPToolConfig]):
        ...
        for tool in tools:
            ...
            if tool.transport_type not in self.supported_transports:
                ...
                raise ValueError(f"Unsupported transport type: {tool.transport_type}. Supported: {supported}")
    ...
    def save_config(self, config: Dict[str, Any], filepath: str = "servers_config.json"):
